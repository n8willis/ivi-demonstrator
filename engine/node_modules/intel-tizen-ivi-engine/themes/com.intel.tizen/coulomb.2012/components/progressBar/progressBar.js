...
(function ($) {
	/**
	 * Class which provides methods to operate with progress bar and also provides volume control for audio.
	...
	var progressBarPlugin = {
			...
			audioSel: null,
			/** 
			 * Method initialize progress bar where appearance depends on input parameter
			 * @method init
			 * @param appearance {String} For volume control it is value "volumeControl" and for progress bar it is "progressBar".
			 */
			init : function (appearance) {
			...
			/** 
			 * Method sets progress bar position.
			 * @method setPosition
			 * @param pos {Integer} Value of position in progress bar.
			 */
			setPosition: function (pos) {
				$('#VCinner').css('width', pos + '%');
			},
			/** 
	...
	/** 
	 * jQuery extension method for class `com.intel.tizen.coulomb.2012.progressBarPlugin`
